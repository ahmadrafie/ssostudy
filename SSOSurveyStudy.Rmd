...
```{r}
plot1 <- plot_model(model3b, type = "pred", terms = c("privacy", "agreeableness[1,3,5,7]"), title = "", axis.title = c("Privacy Concerns", "Predicted Security Awareness Score"), legend.title = "Agreeableness") + ylim(0, 100)
plot2 <- plot_model(model3b, type = "pred", terms = c("privacy", "conscientiousness[1,3,5,7]"), title = "", axis.title = c("Privacy Concerns", "Predicted Security Awareness Score"), legend.title = "Conscientiousness")+ ylim(0, 100)
#plot1
#plot2
fig4 <- grid.arrange(plot1, plot2, ncol=2,top=textGrob("Marginal Effects on SSO Security Awareness Score"))
