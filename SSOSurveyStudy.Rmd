...
```{r}
plot1 <- plot_model(model3b, type = "pred", terms = c("privacy", "agreeableness[1,3,5,7]"), title = "", axis.title = c("Privacy Concerns", "Predicted Security Awareness Score"), legend.title = "Agreeableness", colors = "PRGn") + ylim(0, 100) + aes(linetype=group, color=group)
plot2 <- plot_model(model3b, type = "pred", terms = c("privacy", "conscientiousness[1,3,5,7]"), title = "", axis.title = c("Privacy Concerns", "Predicted Security Awareness Score"), legend.title = "Conscientiousness", colors = "PRGn")+ ylim(0, 100) + aes(linetype=group, color=group)
#plot1
#plot2
